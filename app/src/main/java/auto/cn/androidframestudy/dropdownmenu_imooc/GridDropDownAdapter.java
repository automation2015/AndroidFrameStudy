...
public class GridDropDownAdapter extends BaseAdapter {
    ...
    public GridDropDownAdapter(Context context, List<String> datas) {
    ...
    private void fillValue(int position, ViewHolder holder) {
        ...
        if(checkItemPosition!=-1){
            if(checkItemPosition==position){
                ...
                holder.tv.setCompoundDrawablesWithIntrinsicBounds(null,null,context.getResources().getDrawable(R.drawable.iv_icon1),null);
            }else{
